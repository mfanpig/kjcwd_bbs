...
$_config['db']['1']['dbuser'] = 'mfanpig_bbs';
$_config['db']['1']['dbpw'] = '52iib8qi';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'VkSW_';
$_config['cookie']['cookiedomain'] = '.kjcwd.com';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '6662a3V7UR8oUXbn';
...
$_config['extend']['storage']['aliyun']['access_id'] = '4uyTfJR8X19agPWK';
$_config['extend']['storage']['aliyun']['access_key'] = '7XBChpmf7623iGJNHhWiVqL63EWzwk';
$_config['extend']['storage']['aliyun']['access_host'] = NULL;
$_config['extend']['storage']['aliyun']['bucket'] = 'kjcwd';
$_config['extend']['storage']['aliyun']['attachurl'] = 'http://cnd.kjwcd.com';
