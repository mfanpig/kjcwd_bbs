...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1436063119, '7', './data/template/7_7_common_header_group_viewthread.tpl.php', './template/time_9th_keji', 'common/header_group_viewthread')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1436063119, '7', './data/template/7_7_common_header_group_viewthread.tpl.php', './template/time_9th_keji', 'common/header_group_viewthread')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1436063119, '7', './data/template/7_7_common_header_group_viewthread.tpl.php', './template/time_9th_keji', 'common/header_group_viewthread')
;?>
