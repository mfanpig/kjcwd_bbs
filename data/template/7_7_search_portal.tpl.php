...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1436106375, '7', './data/template/7_7_search_portal.tpl.php', './template/time_9th_keji', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1436106375, '7', './data/template/7_7_search_portal.tpl.php', './template/time_9th_keji', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1436106375, '7', './data/template/7_7_search_portal.tpl.php', './template/time_9th_keji', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1436106375, '7', './data/template/7_7_search_portal.tpl.php', './template/time_9th_keji', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/time_9th_keji/common/header_common.htm', 1436106375, '7', './data/template/7_7_search_portal.tpl.php', './template/time_9th_keji', 'search/portal')
;?>
