...
block_get('266,265,269,268,270,267,271');?><?php include template('common/header'); $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><link rel="stylesheet" type="text/css" href="template/time_9th_keji/src/list.css" />
...
<div class="tit_top cl"> 
        ...
        <?php } ?>
        <h3><?php echo $cat['catname'];?></h3><div class="cl" style="float: left; min-width: 200px; min-height: 30px;"><!--[diy=diy_info]--><div id="diy_info" class="area"><div id="framej2JHFj" class="frame move-span cl frame-1"><div id="framej2JHFj_left" class="column frame-1-c"><div id="framej2JHFj_left_temp" class="move-span temp"></div><?php block_display('266');?></div></div></div><!--[/diy]--></div> 
</div>
<div id="ct" class="ct2 wp inside_box cl">
  ...
  <div class="sd pph">
    ...
    <div class="sbody cl" style="margin: 10px 0 0 0;"> 
      <!--[diy=sbody]--><div id="sbody" class="area"><div id="frameT9CTdd" class="frame move-span cl frame-1"><div id="frameT9CTdd_left" class="column frame-1-c"><div id="frameT9CTdd_left_temp" class="move-span temp"></div><?php block_display('265');?></div></div><div id="frameBBowy9" class="frame move-span cl frame-1"><div id="frameBBowy9_left" class="column frame-1-c"><div id="frameBBowy9_left_temp" class="move-span temp"></div><?php block_display('269');?></div></div><div id="framefDw6SD" class="frame move-span cl frame-1"><div id="framefDw6SD_left" class="column frame-1-c"><div id="framefDw6SD_left_temp" class="move-span temp"></div><?php block_display('268');?></div></div><div id="framepwQwf6" class="frame move-span cl frame-1"><div id="framepwQwf6_left" class="column frame-1-c"><div id="framepwQwf6_left_temp" class="move-span temp"></div><?php block_display('270');?><?php block_display('267');?><?php block_display('271');?></div></div></div><!--[/diy]--> 
    </div>
