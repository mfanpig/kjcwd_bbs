...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1435843057, '7', './data/template/7_7_common_header_group_forumdisplay.tpl.php', './template/time_9th_keji', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1435843057, '7', './data/template/7_7_common_header_group_forumdisplay.tpl.php', './template/time_9th_keji', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1435843057, '7', './data/template/7_7_common_header_group_forumdisplay.tpl.php', './template/time_9th_keji', 'common/header_group_forumdisplay')
;?>
