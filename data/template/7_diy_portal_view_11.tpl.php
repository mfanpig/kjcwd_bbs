...
0
|| checktplrefresh('data/diy/./template/time_9th_keji//portal/view_11.htm', './template/time_9th_keji/portal/portal_comment.htm', 1436444983, 'diy', './data/template/7_diy_portal_view_11.tpl.php', 'data/diy/./template/time_9th_keji/', 'portal/view_11')
|| checktplrefresh('data/diy/./template/time_9th_keji//portal/view_11.htm', './template/default/common/seccheck.htm', 1436444983, 'diy', './data/template/7_diy_portal_view_11.tpl.php', 'data/diy/./template/time_9th_keji/', 'portal/view_11')
...
<!-- 多说评论框 start -->
<div class="ds-thread" data-thread-key=“<?php echo $article['id'];?>" data-title="<?php echo $article['title'];?>}" data-url="<?php echo $article['url'];?>"></div>
<!-- 多说评论框 end -->
<!-- 多说公共JS代码 start (一个网页只需插入一次) -->
<script type="text/javascript">
var duoshuoQuery = {short_name:"kjcwd"};
(function() {
