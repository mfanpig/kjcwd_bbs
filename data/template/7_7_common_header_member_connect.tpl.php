...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1436168347, '7', './data/template/7_7_common_header_member_connect.tpl.php', './template/time_9th_keji', 'common/header_member_connect')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1436168347, '7', './data/template/7_7_common_header_member_connect.tpl.php', './template/time_9th_keji', 'common/header_member_connect')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1436168347, '7', './data/template/7_7_common_header_member_connect.tpl.php', './template/time_9th_keji', 'common/header_member_connect')
;?>
