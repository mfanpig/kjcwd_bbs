...
0
|| checktplrefresh('./template/time_9th_keji/forum/guide.htm', './template/time_9th_keji/forum/guide_list_row.htm', 1436307420, '7', './data/template/7_7_forum_guide.tpl.php', './template/time_9th_keji', 'forum/guide')
...
<?php echo $multipage;?>
<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav" style="display: block; float: left; background: #555555;"><img src="<?php echo $_G['style']['styleimgdir'];?>/pn_post.png" alt="发新帖" /></a>
</div>
<?php } ?>
