...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1435843131, '7', './data/template/7_7_member_login.tpl.php', './template/time_9th_keji', 'member/login')
