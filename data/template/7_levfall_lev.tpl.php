...
0
|| checktplrefresh('./source/plugin/levfall/template/lev.htm', './template/time_9th_keji/common/header.htm', 1436311048, 'levfall', './data/template/7_levfall_lev.tpl.php', './source/plugin/levfall/template', 'lev')
|| checktplrefresh('./source/plugin/levfall/template/lev.htm', './template/time_9th_keji/common/footer.htm', 1436311048, 'levfall', './data/template/7_levfall_lev.tpl.php', './source/plugin/levfall/template', 'lev')
|| checktplrefresh('./source/plugin/levfall/template/lev.htm', './template/time_9th_keji/common/header_common.htm', 1436311048, 'levfall', './data/template/7_levfall_lev.tpl.php', './source/plugin/levfall/template', 'lev')
|| checktplrefresh('./source/plugin/levfall/template/lev.htm', './template/time_9th_keji/common/pubsearchform.htm', 1436311048, 'levfall', './data/template/7_levfall_lev.tpl.php', './source/plugin/levfall/template', 'lev')
|| checktplrefresh('./source/plugin/levfall/template/lev.htm', './template/default/common/header_qmenu.htm', 1436311048, 'levfall', './data/template/7_levfall_lev.tpl.php', './source/plugin/levfall/template', 'lev')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_7_common.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?>    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/pace.js" type="text/javascript"></script>
  ...
  <div id="topbar" class="cl"> 
    ...
    <div class="wp"> 
      ...
      <div class="userbox"> 
        <?php if($_G['uid']) { ?>
        <ul class="usernav">
          <li class="user_list" style="margin: 0 0 0 15px;"><a id="nte_menu" href="home.php?mod=space&amp;do=notice" class="user_link notification">提醒<?php if($_G['member']['newprompt']) { ?><span class="unread_num png"><?php echo $_G['member']['newprompt'];?></span><?php } ?></a> </li>
        ...
        <ul class="usernav user_part">
          ...
          <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="user_login" style="margin: 0;">注册</a>
        </ul>
...
<!--[if lt IE 9]><script src="<?php echo lev_fall::$PLSTATIC?>html5.js" type="text/javascript"></script><![endif]-->
  
<link type="text/css" rel="stylesheet" href="<?php echo lev_fall::$PLSTATIC?>css/fall.css">

<script src="<?php echo lev_fall::$PLSTATIC?>dialog417/dialog.js?skin=default" type="text/javascript"></script>
<script src="<?php echo lev_fall::$PLSTATIC?>jquery.min.js" type="text/javascript"></script>

<script src="<?php echo lev_fall::$PLSTATIC?>jquery.masonry.min.js" type="text/javascript"></script>
<script src="<?php echo lev_fall::$PLSTATIC?>jquery.infinitescroll.min.js" type="text/javascript"></script>
...
<tr><td><a href="plugin.php?id=levfall:lev"><?php echo $lev_lang['nav'];?></a></td></tr>
</table>
</div><?php if(is_array($forums)) foreach($forums as $f) { if($f['fup'] && ($fnums < lev_fall::$PL_G['nav_nums'] || $navall)) { $fnums++;?><div class="navtc" <?php if($f['fid'] == $__fids) { ?>style="background:#f9f9f9"<?php } ?>>
<table width="210" cellspacing="0">
<tr><td><a href="plugin.php?id=levfall:lev&amp;na=<?php echo $navall;?>&amp;fid=<?php echo $f['fid'];?>"><?php echo $f['name'];?></a></td></tr>
</table>
</div>
<?php } } if(!$navall && count($forums) > lev_fall::$PL_G['nav_nums']) { ?>
<div class="navtitle">
<table width="210" cellspacing="0">
<tr><td><a href="plugin.php?id=levfall:lev&amp;na=1"><?php echo $lev_lang['all'];?></a></td></tr>
</table>
</div>
<?php } ?>
</div>
</div><!--item end--><?php include template (lev_fall::$PLNAME.':page');?></div>


<div id="more"><a href="<?php echo lev_fall::$PLURL?>&ajax=<?php echo $_GET['page'];?>&page=2"></a></div>

<div id="page" class="page" style="display:none;"><?php echo $pages;?></div>
...
gutterWidth:15		
    ...
    container.infinitescroll({
      ...
      itemSelector : '.item', 
      loading: {
  msgText: '<?php echo $lev_lang['loading'];?>',
          finishedMsg: '<?php echo $lev_lang['finish'];?>',
          img: '<?php echo lev_fall::$PLSTATIC?>images/loading2.gif'
        },errorCallback:function(){ 
$$("#page").show();
}
      },
      function( newElements ) {
       	 var $<?php echo $newElems;?> = $$( newElements ).css({ opacity: 0 });
       	$<?php echo $newElems;?>.imagesLoaded(function(){
         $<?php echo $newElems;?>.animate({ opacity: 1 });
         container.masonry( 'appended', $<?php echo $newElems;?>, true ); 
  		 item_callback();
        });
      }
    );
