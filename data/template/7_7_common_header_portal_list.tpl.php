...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1435901177, '7', './data/template/7_7_common_header_portal_list.tpl.php', './template/time_9th_keji', 'common/header_portal_list')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1435901177, '7', './data/template/7_7_common_header_portal_list.tpl.php', './template/time_9th_keji', 'common/header_portal_list')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1435901177, '7', './data/template/7_7_common_header_portal_list.tpl.php', './template/time_9th_keji', 'common/header_portal_list')
;?>
