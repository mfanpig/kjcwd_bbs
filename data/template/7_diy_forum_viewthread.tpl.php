...
0
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/time_9th_keji/forum/viewthread_node.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/time_9th_keji/forum/viewthread_fastpost.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/time_9th_keji/forum/viewthread_node_body.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/default/common/seditor.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/default/common/seccheck.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/viewthread.htm', './template/default/common/upload.htm', 1436532435, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/viewthread')
;
block_get('178,176,177,173,174,175');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<div class="forum-right">
          ...
          <div id="sd_bdr">           
            <div class="drag"> 
              <!--[diy=forum-bar]--><div id="forum-bar" class="area"><div id="framekE1AFt" class="frame move-span cl frame-1"><div id="framekE1AFt_left" class="column frame-1-c"><div id="framekE1AFt_left_temp" class="move-span temp"></div><?php block_display('178');?></div></div></div><!--[/diy]--> 
            </div>
          </div>
          
          <div class="view-hot">
            <div class="bd">
               <!--[diy=view_hot]--><div id="view_hot" class="area"><div id="framey41V5x" class="frame move-span cl frame-1"><div id="framey41V5x_left" class="column frame-1-c"><div id="framey41V5x_left_temp" class="move-span temp"></div><?php block_display('176');?></div></div><div id="framebL717m" class="frame move-span cl frame-1"><div id="framebL717m_left" class="column frame-1-c"><div id="framebL717m_left_temp" class="move-span temp"></div><?php block_display('177');?></div></div></div><!--[/diy]-->          
            </div>
          </div>
          
          
        <div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameZwDhoe" class="frame move-span cl frame-1"><div id="frameZwDhoe_left" class="column frame-1-c"><div id="frameZwDhoe_left_temp" class="move-span temp"></div><?php block_display('173');?><?php block_display('174');?><?php block_display('175');?></div></div></div><!--[/diy]-->
</div>
        </div>
        <!-- 板块右侧 -->
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>" class="forum_type"><?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?> --- </a>
<?php } else { ?>
...
<td class="plc"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
    <i class="arr"></i>
<div class="pi <?php if($post['first']) { ?>tpi<?php } ?>"<?php if($close_leftinfo || (!$post['first'] && !$post['anonymous'] && $postshowavatars && $showavatars)) { ?> style="height: 44px;"<?php } ?>>
...
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2 z inside_avt" style="padding-right:10px;"><?php echo avatar($post['authorid'], 'small'); ?></a><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($_self ) { ?>
...
<em id="authorposton<?php echo $post['pid'];?>"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" style="padding: 0 5px 0 0; color: #555555; font-size: 14px; font-weight: bold;"><?php echo $post['author'];?></a> 发表于 <?php echo $post['dateline'];?></em>
...
</div><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct" style="color: #515151;"><?php echo adshow("thread/a_pt/2/$postcount");?><?php if(!$_G['inajax']) { if(empty($ad_a_pr_css)) { ?>
...
<div class="cl">
<!--  快捷表情位置  <?php if(empty($_GET['from']) && $_G['setting']['fastsmilies']) { ?> class="hasfsl"<?php } ?> -->
