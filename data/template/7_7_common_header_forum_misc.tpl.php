...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1436558305, '7', './data/template/7_7_common_header_forum_misc.tpl.php', './template/time_9th_keji', 'common/header_forum_misc')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1436558305, '7', './data/template/7_7_common_header_forum_misc.tpl.php', './template/time_9th_keji', 'common/header_forum_misc')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1436558305, '7', './data/template/7_7_common_header_forum_misc.tpl.php', './template/time_9th_keji', 'common/header_forum_misc')
;?>
