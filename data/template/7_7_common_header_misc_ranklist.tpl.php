...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1436765083, '7', './data/template/7_7_common_header_misc_ranklist.tpl.php', './template/time_9th_keji', 'common/header_misc_ranklist')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1436765083, '7', './data/template/7_7_common_header_misc_ranklist.tpl.php', './template/time_9th_keji', 'common/header_misc_ranklist')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1436765083, '7', './data/template/7_7_common_header_misc_ranklist.tpl.php', './template/time_9th_keji', 'common/header_misc_ranklist')
;?>
