...
0
|| checktplrefresh('./template/time_9th_keji/home/space_menu.htm', './template/time_9th_keji/home/follow_user_header.htm', 1435856833, '7', './data/template/7_7_home_space_menu.tpl.php', './template/time_9th_keji', 'home/space_menu')
;?>
<link rel="stylesheet" type="text/css" href='template/time_9th_keji/home/home.css' />
<style>
.bm { padding: 0 20px}
...
<ul>
<?php if(helper_access::check_module('follow')) { ?>
<li class="addflw" style="float: left; margin: 0 10px 0 0;">
...
<?php if(!empty($_G['setting']['pluginhooks']['space_menu_extra'])) echo $_G['setting']['pluginhooks']['space_menu_extra'];?>
 ...
 <ul class="tb_1 cl">
        <li<?php if($do==profile) { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=profile&amp;from=space"><img src="template/time_9th_keji/src/space_profile.png" class="vm"></img>TA的资料</a></li>
<?php if(helper_access::check_module('follow')) { ?>
<li<?php if(CURMODULE == 'follow') { ?> class="a"<?php } ?>><a href="home.php?mod=follow&amp;uid=<?php echo $space['uid'];?>&amp;do=view&amp;from=space"><img src="template/time_9th_keji/src/space_follow.png" class="vm"></img>广播</a></li>
<?php } ?>
        <li<?php if($do=='thread') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_thread.png" class="vm"></img>主题</a></li>
<?php if(helper_access::check_module('blog')) { ?>
<li<?php if($do=='blog') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_blog.png" class="vm"></img>日志</a></li>
<?php } if(helper_access::check_module('album')) { ?>
<li<?php if($do=='album') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=album&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_album.png" class="vm"></img>相册</a></li>
<?php } if(helper_access::check_module('doing')) { ?>
<li<?php if($do=='doing') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_doing.png" class="vm"></img>记录</a></li>
<?php } if(helper_access::check_module('home')) { ?>
<li<?php if($do=='home') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=home&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_feed.png" class="vm"></img>动态</a></li>
<?php } if(helper_access::check_module('share')) { ?>
<li<?php if($do=='share') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=share&amp;view=me&amp;from=space"><img src="template/time_9th_keji/src/space_share.png" class="vm"></img>分享</a></li>
<?php } if(helper_access::check_module('wall')) { ?>
<li<?php if($do==wall) { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=wall&amp;from=space"><img src="template/time_9th_keji/src/space_message.png" class="vm"></img>留言板</a></li>
<?php } ?>
 </ul>
    </div>
</div>
