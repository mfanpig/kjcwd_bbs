...
0
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/header_ajax.htm', 1435887333, '7', './data/template/7_7_portal_portal_attachment.tpl.php', './template/time_9th_keji', 'portal/portal_attachment')
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/footer_ajax.htm', 1435887333, '7', './data/template/7_7_portal_portal_attachment.tpl.php', './template/time_9th_keji', 'portal/portal_attachment')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
