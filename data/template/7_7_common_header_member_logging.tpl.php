...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1435968730, '7', './data/template/7_7_common_header_member_logging.tpl.php', './template/time_9th_keji', 'common/header_member_logging')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1435968730, '7', './data/template/7_7_common_header_member_logging.tpl.php', './template/time_9th_keji', 'common/header_member_logging')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1435968730, '7', './data/template/7_7_common_header_member_logging.tpl.php', './template/time_9th_keji', 'common/header_member_logging')
;?>
