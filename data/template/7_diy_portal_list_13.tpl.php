...
block_get('118,117,121,120,122,119,123');?><?php include template('common/header'); $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><link rel="stylesheet" type="text/css" href="template/time_9th_keji/src/list.css" />
...
<div class="tit_top cl"> 
        ...
        <?php } ?>
        <h3><?php echo $cat['catname'];?></h3><div class="cl" style="float: left; min-width: 200px; min-height: 30px;"><!--[diy=diy_info]--><div id="diy_info" class="area"><div id="frameIQTRw1" class="frame move-span cl frame-1"><div id="frameIQTRw1_left" class="column frame-1-c"><div id="frameIQTRw1_left_temp" class="move-span temp"></div><?php block_display('118');?></div></div></div><!--[/diy]--></div> 
</div>
<div id="ct" class="ct2 wp inside_box cl">
  ...
  <div class="sd pph">
    ...
    <div class="sbody cl" style="margin: 10px 0 0 0;"> 
      <!--[diy=sbody]--><div id="sbody" class="area"><div id="frameu6R6F4" class="frame move-span cl frame-1"><div id="frameu6R6F4_left" class="column frame-1-c"><div id="frameu6R6F4_left_temp" class="move-span temp"></div><?php block_display('117');?></div></div><div id="frameYY585Q" class="frame move-span cl frame-1"><div id="frameYY585Q_left" class="column frame-1-c"><div id="frameYY585Q_left_temp" class="move-span temp"></div><?php block_display('121');?></div></div><div id="framekxDk81" class="frame move-span cl frame-1"><div id="framekxDk81_left" class="column frame-1-c"><div id="framekxDk81_left_temp" class="move-span temp"></div><?php block_display('120');?></div></div><div id="frameq5vscz" class="frame move-span cl frame-1"><div id="frameq5vscz_left" class="column frame-1-c"><div id="frameq5vscz_left_temp" class="move-span temp"></div><?php block_display('122');?><?php block_display('119');?><?php block_display('123');?></div></div></div><!--[/diy]--> 
    </div>
