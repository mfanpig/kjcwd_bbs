...
0
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/header_common.htm', 1435912116, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/time_9th_keji', 'common/header_member_register')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/time_9th_keji/common/pubsearchform.htm', 1435912116, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/time_9th_keji', 'common/header_member_register')
|| checktplrefresh('./template/time_9th_keji/common/header.htm', './template/default/common/header_qmenu.htm', 1435912116, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/time_9th_keji', 'common/header_member_register')
;?>
