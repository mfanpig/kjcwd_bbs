...
0
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/time_9th_keji/forum/forumdisplay_leftside.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/time_9th_keji/forum/recommend.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/time_9th_keji/forum/forumdisplay_list.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/time_9th_keji//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1436447083, 'diy', './data/template/7_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/time_9th_keji/', 'forum/forumdisplay')
;
block_get('137,136,134,135,131,132,133');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<?php } ?>
  ...
  <div class="thread_post cl">
             <a id="thread_post" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖"><img src="template/time_9th_keji/src/thread_post.png" alt="发新帖"></a>
          </div>
    <div id="sd_bdr">
      ...
      <div class="forum-bar">
        <div class="forum_hd" style="margin: 0 0 20px 0;">
           <h2>版块信息</h2>
           <span>今日发帖 : <?php if(!$subforumonly) { ?><?php echo $_G['forum']['todayposts'];?><?php } ?></span>
        </div>
        <?php if($moderatedby) { ?>
        ...
        <!--[diy=diy_top]--><div id="diy_top" class="area"><div id="frameZq1oy4" class="frame move-span cl frame-1"><div id="frameZq1oy4_left" class="column frame-1-c"><div id="frameZq1oy4_left_temp" class="move-span temp"></div><?php block_display('137');?></div></div></div><!--[/diy]-->
      ...
      <div class="drag"> 
        <!--[diy=diy2]--><div id="diy2" class="area"><div id="framephzkJY" class="frame move-span cl frame-1"><div id="framephzkJY_left" class="column frame-1-c"><div id="framephzkJY_left_temp" class="move-span temp"></div><?php block_display('136');?><div id="frameH5ZoIW" class="frame move-span cl frame-1"><div id="frameH5ZoIW_left" class="column frame-1-c"><div id="frameH5ZoIW_left_temp" class="move-span temp"></div><?php block_display('134');?></div></div></div></div><div id="frameOUH9IQ" class="frame move-span cl frame-1"><div id="frameOUH9IQ_left" class="column frame-1-c"><div id="frameOUH9IQ_left_temp" class="move-span temp"></div><?php block_display('135');?></div></div><div id="framemTgDwe" class="frame move-span cl frame-1"><div id="framemTgDwe_left" class="column frame-1-c"><div id="framemTgDwe_left_temp" class="move-span temp"></div><?php block_display('131');?><?php block_display('132');?><?php block_display('133');?></div></div></div><!--[/diy]-->
      </div>
      ...
      <div class="bm bml">
        <div class="bm_h cl">
          <div id="pt" class="bm cl z">
            <div class="z"><a href="forum.php"<?php if($_G['setting']['forumjump']) { ?> id="fjump" onmouseover="delayShow(this, 'showForummenu(<?php echo $_G['fid'];?>)');" class="showmenu" <?php } ?>><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> </div>
          </div>
          
          <?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?><span class="o cl"><img id="forum_rules_<?php echo $_G['fid'];?>_img" src="<?php echo IMGDIR;?>/collapsed_<?php echo $collapse['forum_rulesimg'];?>.gif" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('forum_rules_<?php echo $_G['fid'];?>')" /></span><?php } ?> 
          <span class="y"> 
          ...
          <?php } ?> 
      <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" class="fa_fav" onclick="showWindow(this.id, this.href, 'get', 0);" style="padding: 0; background: none;">收藏本版 <strong class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?> style="font-weight: 400;">(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</strong></a>
          </span> </div>
...
<?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { ?><td class="o cl">&nbsp;</td><?php } ?>
...
<th style="border-right: 1px solid #E8E8E8;"><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></th>
</tr>
</tbody>
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/digest_<?php echo $thread['digest'];?>.png" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['displayorder'] == 0) { if($thread['recommendicon'] && $filter != 'recommend') { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } else { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/time_common/folder_<?php echo $thread['folder'];?>.gif" />
<?php } ?>
</a>
